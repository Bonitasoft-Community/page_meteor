...
public class SingleRunner extends Runner {
	...
	public void execute() throws Exception {
		...
		if(gsContent == null || gsContent.isEmpty()) {
			...
			// Extract and combine the imports/scripts coming from GS dependencies
			...
			// Build the header (add the snippet imports in the functions part and then the functions in the header part)
