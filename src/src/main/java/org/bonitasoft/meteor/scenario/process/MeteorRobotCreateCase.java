...
import org.bonitasoft.meteor.MeteorRobot.FINALSTATUS;
...
public class MeteorRobotCreateCase extends MeteorRobot {
	...
	public void executeRobot() {
		...
		mCollectPerformance.mTitle = "CREATE CASE: " + mMeteorProcess.getInformation() + " #" + mRobotId;
		...
		try {
			...
			for (mCollectPerformance.mOperationIndex = 0; mCollectPerformance.mOperationIndex < mMeteorProcess.mNumberOfCases; mCollectPerformance.mOperationIndex++) {
				logger.info("--------- SID #" + meteorSimulation.getId() + " ROBOT #" + mRobotId + " ------ Advancement " + mCollectPerformance.mOperationIndex + " / " + mMeteorProcess.mNumberOfCases + " Sleep[" + mMeteorProcess.mTimeSleep + "]");
