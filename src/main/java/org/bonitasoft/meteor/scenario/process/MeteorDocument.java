...
public class MeteorDocument {
    ...
    public String getHtmlId() {
        return MeteorScenarioProcess.CSTHTML_PREFIXDOCUMENT + (mMeteorProcess == null ? "" : mMeteorProcess.mProcessDefinitionId.toString()) + "_" + (mMeteorActivity == null ? "" : mMeteorActivity.mActivityDefinitionId.toString()) + "_" + mIndice;
