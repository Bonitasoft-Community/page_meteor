    ...
    public void executeRobot() {
        ...
        try {
            ...
            for (mCollectPerformance.mOperationIndex = 0; mCollectPerformance.mOperationIndex < mCollectPerformance.mOperationTotal; mCollectPerformance.mOperationIndex++) {
                ...
                Long taskId = executeActivity(mMeteorActivity.getMeteorProcess().mProcessDefinitionId, mMeteorActivity.mActivityName, mMeteorActivity.mInputs, meteorInputItem, mMeteorActivity.mTimeSleep, getRobotId(), mLogExecution, processAPI, identityAPI);
